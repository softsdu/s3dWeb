...
function onPointerDown( event ) {
	...
	//增加event的传递 modified by ls 202204
...
class TransformControlsGizmo extends THREE.Object3D {
	...
	constructor() {
		...
		*/
		const lineGeometry2 = new THREE.CylinderGeometry( 0.0025, 0.0025, 0.5, 3 );
		lineGeometry2.translate( 0, 0.25, 0 );
		...
		const gizmoTranslate = {
			X: [
				...
				/* 隐藏负向箭头 deleted by ls 20220617
				[ new THREE.Mesh( arrowGeometry, matRed ), [ - 0.5, 0, 0 ], [ 0, 0, Math.PI / 2 ]],
				*/
				[ new THREE.Mesh( lineGeometry2, matRed ), [ 0, 0, 0 ], [ 0, 0, - Math.PI / 2 ]]
			],
			/* 隐藏Y方向 deleted by ls 20220617
			Y: [
			...
			*/
			XZ: [
				/* 更改偏移量 modified by ls 20220617
				[ new THREE.Mesh( new THREE.BoxGeometry( 0.15, 0.15, 0.01 ), matGreenTransparent.clone() ), [ 0.15, 0, 0.15 ], [ - Math.PI / 2, 0, 0 ]]
				*/
				[ new THREE.Mesh( new THREE.BoxGeometry( 0.2, 0.2, 0.01 ), matGreenTransparent.clone() ), [ 0.2, 0, 0.2 ], [ - Math.PI / 2, 0, 0 ]]				
			]
		};
		...
		const pickerTranslate = {
			...
			*/
			XZ: [
				...
				*/
				[ new THREE.Mesh( new THREE.BoxGeometry( 0.2, 0.2, 0.01 ), matInvisible ), [ 0.2, 0, 0.2 ], [ - Math.PI / 2, 0, 0 ]]
			]
		};

		const helperTranslate = {
			/* 曲线显示移动的helper deleted by ls 20220617
			START: [
