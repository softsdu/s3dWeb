...
THREE.GLTFLoader = ( function () {
	...
	GLTFLoader.prototype = {
		...
		//创建gltf的parse，added by ls 20210803
		getParser: function ( data, path, onError) {
	...
	function resolveURL( url, path ) {
		...
		//如果是获取bin，那么特殊处理，不拼接路径了 modified by ls 2010803
		if(url.endWith("bin")){
			return path;
		}
		else{
	...
	GLTFParser.prototype.loadMaterial = function ( materialIndex ) {
		...
		if ( materialExtensions[ EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS ] ) {
			...
			materialParams.metalness = metallicRoughness.metallicFactor !== undefined ? metallicRoughness.metallicFactor : 0.5;
			//materialParams.metalness = 0.4;
			//modified by ls 默认改为0.5
			//materialParams.roughness = metallicRoughness.roughnessFactor !== undefined ? metallicRoughness.roughnessFactor : 1.0;
			materialParams.roughness = metallicRoughness.roughnessFactor !== undefined ? metallicRoughness.roughnessFactor : 0;
